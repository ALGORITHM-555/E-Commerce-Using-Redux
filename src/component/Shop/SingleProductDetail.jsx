                        ...
                        <div className="product-images">
                            <main id="gallery">
                                ...
                                <div className="images">
                                    <img src="/images/product-details/01.jpg" className="img" alt="#" />
                                    <img src="/images/product-details/02.jpg" className="img" alt="#" />
                                    <img src="/images/product-details/03.jpg" className="img" alt="#" />
                                    <img src="/images/product-details/04.jpg" className="img" alt="#" />
                                    <img src="/images/product-details/05.jpg" className="img" alt="#" />
                                </div>
                            </main>
                        </div>
                    </div>
                        ...
                        <div className="col-lg-6 col-12">
                            <div className="info-body custom-responsive-margin">
                                ...
                                <ul className="features">
                                    ...
                                    <li>Use App htmlFor Dedicated Camera Operation</li>
                                </ul>
                            </div>
                        </div>
                        <div className="col-lg-6 col-12">
                ...
                <div className="row">
                    <div className="col-lg-4 col-12">
                        <div className="single-block give-review">
                            ...
                            <button type="button" className="btn review-btn" data-bs-toggle="modal" data-bs-target="#exampleModal">Leave a Review</button>
                        </div>
                    </div>
                            ...
                            <div className="reviews">
                                ...
                                <div className="single-review">
                                    ...
                                    <div className="review-info">
                                        <h4>Awesome quality htmlFor the price
                                ...
                                <div className="single-review">
                                    ...
                                    <div className="review-info"><h4>I love the built quality...<span>Jacob Hammond</span>
                                        </h4>
                                        <ul className="stars">
                                            <li><i className="lni lni-star-filled"></i></li>
                                            <li><i className="lni lni-star-filled"></i></li>
