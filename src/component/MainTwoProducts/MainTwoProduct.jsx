      ...
      <section className="banner section">
        <div className="container">
            <div className="row">
                ...
                <div className="col-lg-6 col-md-6 col-12">
                    <div className="single-banner custom-responsive-margin" style={{backgroundImage: "url('/images/banner/banner-2-bg.jpg')"}}>
                        <div className="content">
